...
class Fan : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val softSound: MediaPlayer = MediaPlayer.create(this, R.raw.fansoundslol)
        ...
        prevButton.setOnClickListener {
            softSound.stop()
            val prevIntent = Intent(this, Rain :: class.java)
            startActivity(prevIntent)
        }

        nextButton.setOnClickListener {
            softSound.stop()
            val nextIntent = Intent(this, Lawn :: class.java)
