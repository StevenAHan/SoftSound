...
class Lawn : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val softSound: MediaPlayer = MediaPlayer.create(this, R.raw.lawnsoundslol)
        ...
        prevButton.setOnClickListener {
            softSound.stop()
            val prevIntent = Intent(this, Fan :: class.java)
            startActivity(prevIntent)
        }

        nextButton.setOnClickListener {
            softSound.stop()
            val nextIntent = Intent(this, Stream :: class.java)
