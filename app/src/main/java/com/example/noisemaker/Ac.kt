...
class Ac : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val softSound: MediaPlayer = MediaPlayer.create(this, R.raw.acsoundslol)
        ...
        prevButton.setOnClickListener {
            softSound.stop()
            val prevIntent = Intent(this, Stream :: class.java)
            startActivity(prevIntent)
        }

        nextButton.setOnClickListener {
            softSound.stop()
            val nextIntent = Intent(this, Shower :: class.java)
