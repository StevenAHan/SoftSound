...
class Shower : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val softSound: MediaPlayer = MediaPlayer.create(this, R.raw.showersoundslol)
        ...
        prevButton.setOnClickListener {
            softSound.stop()
            val prevIntent = Intent(this, Ac :: class.java)
            startActivity(prevIntent)
        }

        nextButton.setOnClickListener {
            softSound.stop()
            val nextIntent = Intent(this, Rain :: class.java)
