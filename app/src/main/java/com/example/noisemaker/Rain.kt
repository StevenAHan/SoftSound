...
class Rain : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val softSound: MediaPlayer = MediaPlayer.create(this, R.raw.rainsoundslol)
        ...
        prevButton.setOnClickListener {
            softSound.stop()
            val prevIntent = Intent(this, Shower :: class.java)
            startActivity(prevIntent)
        }

        nextButton.setOnClickListener {
            softSound.stop()
            val nextIntent = Intent(this, Fan :: class.java)
